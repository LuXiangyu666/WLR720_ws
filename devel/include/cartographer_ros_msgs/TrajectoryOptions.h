...
struct TrajectoryOptions_
{
  ...
  (void)_alloc;
   ...
   typedef std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>> _tracking_frame_type;
  _tracking_frame_type tracking_frame;

   typedef std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>> _published_frame_type;
  ...
  _landmarks_sampling_ratio_type landmarks_sampling_ratio;
   ...
   typedef std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>> _trajectory_builder_options_proto_type;
...
bool operator==(const ::cartographer_ros_msgs::TrajectoryOptions_<ContainerAllocator1> & lhs, const ::cartographer_ros_msgs::TrajectoryOptions_<ContainerAllocator2> & rhs)
{
  return lhs.tracking_frame == rhs.tracking_frame &&
    lhs.published_frame == rhs.published_frame &&
    lhs.odom_frame == rhs.odom_frame &&
    lhs.provide_odom_frame == rhs.provide_odom_frame &&
    lhs.use_odometry == rhs.use_odometry &&
    lhs.use_nav_sat == rhs.use_nav_sat &&
    lhs.use_landmarks == rhs.use_landmarks &&
    lhs.publish_frame_projected_to_2d == rhs.publish_frame_projected_to_2d &&
    lhs.num_laser_scans == rhs.num_laser_scans &&
    lhs.num_multi_echo_laser_scans == rhs.num_multi_echo_laser_scans &&
    lhs.num_subdivisions_per_laser_scan == rhs.num_subdivisions_per_laser_scan &&
    lhs.num_point_clouds == rhs.num_point_clouds &&
    lhs.rangefinder_sampling_ratio == rhs.rangefinder_sampling_ratio &&
    lhs.odometry_sampling_ratio == rhs.odometry_sampling_ratio &&
    lhs.fixed_frame_pose_sampling_ratio == rhs.fixed_frame_pose_sampling_ratio &&
    lhs.imu_sampling_ratio == rhs.imu_sampling_ratio &&
    lhs.landmarks_sampling_ratio == rhs.landmarks_sampling_ratio &&
...
struct Printer< ::cartographer_ros_msgs::TrajectoryOptions_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::cartographer_ros_msgs::TrajectoryOptions_<ContainerAllocator>& v)
  {
    ...
    Printer<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>::stream(s, indent + "  ", v.tracking_frame);
    s << indent << "published_frame: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>::stream(s, indent + "  ", v.published_frame);
    s << indent << "odom_frame: ";
    ...
    Printer<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>::stream(s, indent + "  ", v.trajectory_builder_options_proto);
  }
};
