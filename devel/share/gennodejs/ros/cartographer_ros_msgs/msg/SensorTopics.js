...
class SensorTopics {
  ...
  static getMessageSize(object) {
    let length = 0;
    length += _getByteLength(object.laser_scan_topic);
    length += _getByteLength(object.multi_echo_laser_scan_topic);
    length += _getByteLength(object.point_cloud2_topic);
    length += _getByteLength(object.imu_topic);
    length += _getByteLength(object.odometry_topic);
    length += _getByteLength(object.nav_sat_fix_topic);
    length += _getByteLength(object.landmark_topic);
    return length + 28;
  }
