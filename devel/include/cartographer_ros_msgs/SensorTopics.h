...
struct SensorTopics_
{
  ...
  (void)_alloc;
   ...
   typedef std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>> _laser_scan_topic_type;
  _laser_scan_topic_type laser_scan_topic;

   typedef std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>> _multi_echo_laser_scan_topic_type;
  _multi_echo_laser_scan_topic_type multi_echo_laser_scan_topic;

   typedef std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>> _point_cloud2_topic_type;
  ...
  _imu_topic_type imu_topic;
   ...
   typedef std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>> _odometry_topic_type;
  _odometry_topic_type odometry_topic;

   typedef std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>> _nav_sat_fix_topic_type;
  _nav_sat_fix_topic_type nav_sat_fix_topic;

   typedef std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>> _landmark_topic_type;
...
bool operator==(const ::cartographer_ros_msgs::SensorTopics_<ContainerAllocator1> & lhs, const ::cartographer_ros_msgs::SensorTopics_<ContainerAllocator2> & rhs)
{
  return lhs.laser_scan_topic == rhs.laser_scan_topic &&
...
struct Printer< ::cartographer_ros_msgs::SensorTopics_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::cartographer_ros_msgs::SensorTopics_<ContainerAllocator>& v)
  {
    ...
    Printer<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>::stream(s, indent + "  ", v.laser_scan_topic);
    s << indent << "multi_echo_laser_scan_topic: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>::stream(s, indent + "  ", v.multi_echo_laser_scan_topic);
    s << indent << "point_cloud2_topic: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>::stream(s, indent + "  ", v.point_cloud2_topic);
    s << indent << "imu_topic: ";
    ...
    Printer<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>::stream(s, indent + "  ", v.odometry_topic);
    s << indent << "nav_sat_fix_topic: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>::stream(s, indent + "  ", v.nav_sat_fix_topic);
    s << indent << "landmark_topic: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>::stream(s, indent + "  ", v.landmark_topic);
  }
};
